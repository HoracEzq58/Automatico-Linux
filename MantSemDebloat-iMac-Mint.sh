#!/bin/bash
# --- MantSemDebloat-iMac-Mint.sh (Versión Anti-Ansiedad v2) ---
# Modificado: 28/04/2026
# Usuarios: mastermac (iMac) / cucurucho (945GZM)
# ATENCION: cambiar LOG y USUARIO segun la PC
...
echo "La PC se apagara en 15 minutos..."
sleep 900
sudo shutdown -h now
